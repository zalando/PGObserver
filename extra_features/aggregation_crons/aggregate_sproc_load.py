...
"""
needs to be run as an hourly cronjob
"""

argp = argparse.ArgumentParser(description='Aggregate sproc usage for faster display', add_help=False)
...
sql_do_aggregate = """
    select * from monitor_data.aggregate_sproc_load(%s,%s)
    """
for host in hosts:
