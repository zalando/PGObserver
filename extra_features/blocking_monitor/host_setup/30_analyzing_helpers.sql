...
CREATE OR REPLACE FUNCTION blocking_last_day(IN p_from_date timestamp without time zone DEFAULT NULL::timestamp without time zone, IN p_to_date timestamp without time zone DEFAULT NULL::timestamp without time zone, IN p_is_ignore_advisory boolean DEFAULT true, OUT host_name text, OUT total_time_ss bigint, OUT threads_count bigint, OUT incidents_count bigint, OUT blocking_query text, OUT one_blocked_query text)
